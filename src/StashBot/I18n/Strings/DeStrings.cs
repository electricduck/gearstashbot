...
namespace StashBot.I18n.Strings
{
    public class DeStrings
    {
        public static Dictionary<Localization.Phrase, string> StringDictionary = new Dictionary<Localization.Phrase, string>() {
            ...
            { Localization.Phrase.NoPermissionPurgePost, "Sie haben keine Berechtigung, diesen Beitrag zu löschen" },
            ...
            { Localization.Phrase.Purge, "Reinigen" },
            { Localization.Phrase.Purged, "Gereinigt" },
